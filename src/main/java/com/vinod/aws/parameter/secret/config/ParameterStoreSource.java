...
import com.vinod.aws.parameter.secret.exception.ParameterStoreError;
import com.vinod.aws.parameter.secret.exception.ParameterStoreParameterNotFoundError;
...
public class ParameterStoreSource
{
    ...
    public Object getProperty(String propertyName) {
        try {
            GetParameterResult getParameterResult =  ssmClient.getParameter(new GetParameterRequest().withName(propertyName).withWithDecryption(Boolean.TRUE));
